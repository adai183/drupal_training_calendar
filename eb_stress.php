            ...
            <div class="col-md-9">
                ...
                <div id="sec0" class="row margin-bottom-3">
                    <div class="col-md-12 top-link">
                        ...
                        <a href="#" style="color: #b6d017;"> | Stress and Gene Regulation </a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                ...
                <div class="row margin-top-5 scientific-report">
                    <a href="http://www.cib.csic.es/Memo/grupos/77.pdf" target="_blank">
                        ...
                        <div class="col-md-6 boss">
                            <div>
                                <a href="caballero.php">
                                    <img src="img/cesar_cor.png" alt="" class="img-responsive" style="height:70px;" />
                                </a>
                            </div>
                            <div>
                                <div class="title">
                ...
                <div class="row margin-top-6">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-6 staff">
                            ...
                            <div class="subtitle">
                                <ul>
                                    <li>Diezma Navas, Laura</li>
                                    <li>Guzman Benito, Irene</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <img class="img-responsive" src="img/stress_group.jpg" style="width:100%;"/>
                    </div>
                </div>
                ...
                <a href="#">
                    <div class="row margin-top-1 service-item">
                        <div class="colo-md-12" style="margin-left:10px;">
                            Biogenesis and regulatory functions of virus-derived small interfering RNAs and their impact on plant-virus interactions
                        </div>
                    </div>

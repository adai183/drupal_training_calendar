            ...
            <div class="col-md-9">
                ...
                <div id="sec0" class="row margin-bottom-3">
                    <div class="col-md-12 top-link">
                        ...
                        <a href="#" style="color: #e27c72"> | Functional Proteomics </a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                ...
                <div class="row margin-top-5 scientific-report">
                    <a href="http://www.cib.csic.es/Memo/grupos/66.pdf" target="blank">
                ...
                <div class="row margin-top-6">
                    <div class="col-md-12">
                        <div class="col-md-6 staff">
                            ...
                            <div class="subtitle">
                                <ul>
                                    <li>Casal Álvarez, José Ignacio</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row margin-top-3">
                    <div class="col-md-12 staff">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="subtitle">
                                <ul>
                                    <li>Bartolomé Conde, Rubén Álvaro</li>
                                    <li>Torres Moriano, Sofia</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row margin-top-3">
                    <div class="col-md-12 staff">
                        <div class="col-md-6">
                            ...
                            <div>
                                <ul class="subtitle">
                                    <li>Marquez Moñino, Maria de los Angeles</li>
                                    <li>Poveda Deltell, Maria</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <a href="#">
                    <div class="row margin-top-1 service-item">
                        <div class="colo-md-12" style="margin-left:10px;">
                            Discovery of biomarkers for diagnosis and therapy of colorectal cancer
                        </div>
                    </div>
                </a>
                <a href="#">
                    <div class="row margin-top-1 service-item">
                        <div class="colo-md-12" style="margin-left:10px;">
                            Epithelial-mesenchimal transition in tumor progression
                        </div>
                    </div>
                </a>
                <a href="#">
                    <div class="row margin-top-1 service-item">
                        <div class="colo-md-12" style="margin-left:10px;">
                            Molecular characterization of metastasis in colorectal cancer
                        </div>
                    </div>
                </a>

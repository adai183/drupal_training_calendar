        ...
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <div class="row margin-top-5 scientific-report">
                    <a href="http://www.cib.csic.es/Memo/grupos/60.pdf" target="__blank">
                        ...
                        <div class="col-md-6 boss">
                            <div>
                                <a href="caballero.php">
                                    <img src="img/jose_ro_fer.png" alt="" class="img-responsive" style="height:70px;"/>
                                </a>
                            </div>
                            <div>
                                <div class="title">
                ...
                <div class="row margin-top-6">
                    <div class="col-md-12">
                        <div class="col-md-6 staff">
                            ...
                            <div class="subtitle">
                                <ul>
                                    <li>Rodríguez Fernández, José Luis</li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-md-6 staff">
                ...
                <div class="row margin-top-6">
                    <div class="col-md-12">
                        <div class="col-md-6 staff">
                            ...
                            <div class="subtitle">
                                <ul>
                                    <li>López-Cotarelo García de Diego, Pilar</li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-md-6 staff">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <img class="img-responsive" src="img/functions_group.jpg" style="width:100%;"/>
                    </div>
                </div>
                ...
                <a href="#">
                    <div class="row margin-top-1 service-item">
                        <div class="colo-md-12" style="margin-left:10px;">
                            Functions under the control of the chemokine CXCL12 in dendritic cells
                        </div>
                    </div>
                </a>
                <a href="#">
                    <div class="row margin-top-1 service-item">
                        <div class="colo-md-12" style="margin-left:10px;">
                            Molecular mechanisms that regulate the functions of the chemokine receptor CCR7 in dendritic cells.
                        </div>
                    </div>
                </a>
                <a href="#">
                    <div class="row margin-top-1 service-item">
                        <div class="colo-md-12" style="margin-left:10px;">
                            Regulatory functions of the immunological synapse of dendritic cells
                        </div>
                    </div>
                </a>

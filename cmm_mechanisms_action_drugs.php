        ...
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <div class="row margin-top-5 scientific-report">
                    <a href="http://www.cib.csic.es/Memo/grupos/13.pdf" target="_blank">
                ...
                <div class="row members margin-top-2">
                    <div class="col-md-12">
                        <div class="col-md-6 boss">
                            <div>
                                <img src="img/pat_aller.png" class="img-responsive" style="height: 70px;"/>
                            </div>
                            <div>
                                <div class="title">
                                    Head of Lab
                ...
                <div class="row">
                    <div class="col-md-12">
                        <img class="img-responsive" src="img/action_drugs_group.jpg" style="width:100%"/>
                    </div>
                </div>

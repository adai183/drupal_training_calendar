    ...
    <main class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <div class="row members margin-top-2">
                    <div class="col-md-12">
                        <div class="col-md-6 boss">
                            <div>
                                <img src="img/luis_rivas.png" alt="" class="img-responsive" style="height:70px;"/>
                            </div>
                            <div>
                                <div class="title">
                                    Head of Lab
                ...
                <div class="row margin-top-6">
                    <div class="col-md-12">
                        <div class="col-md-6 staff">
                            ...
                            <div class="subtitle">
                                <ul>
                                    <li>Rivas López, Luis Ignacio</li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-md-6 staff">
                            ...
                            <div class="subtitle">
                                <ul>
                                    <li>Abengozar Infantes, Mª Angeles</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row margin-top-6">
                    <div class="col-md-12">
                        <div class="col-md-6 staff">
                            ...
                            <div class="subtitle">
                                <ul>
                                    <li>Nacher Vázquez, Montserrat</li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-md-6 staff">
                            ...
                            <div class="subtitle">
                                <ul>
                                    <li>Carrasco Navarro, Daniel</li>
                                    <li>Rodriguez de Gaspar Fernandez, Jose Luis</li>
                                    <li>Saiz Acitores, Paula</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <img class="img-responsive" src="img/eukaryotic_group.png" style="width:100%;"/>
                    </div>
                </div>
                ...
                <a href="#">
                    <div class="row margin-top-1 service-item">
                        <div class="colo-md12" style="margin-left:10px;">
                            Quest for new antimicrobial membrane-active peptide leadsand their further development
                        </div>
                    </div>
                </a>
                <a href="#">
                    <div class="row margin-top-1 service-item">
                        <div class="colo-md12" style="margin-left:10px;">
                            Application of cell penetrating peptide technology (CPP)into the Biology and Chemotherapy of  Trypanosomatids
                        </div>
                    </div>
                </a>
                <a href="#">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <ul>
                            <li>ISCIII PI12-02706(2013-2015)</li>
                            <li>ISCIII-FEDER, RD12/0018/0007(2013-2015)</li>
                            <li>FIS RICET RD06-0021-06 (2007-2015)</li>
                        </ul>

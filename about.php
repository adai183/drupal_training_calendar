<?php include('header.php');?>
  ...
  <!-- start page content -->
    <main class="container-fluid">
        ...
        <div id="sec4" class="row margin-top-7 margin-bottom-5">
            <div class="col-md-12 map">
                <img class="img-responsive map-img" src="img/map1.png"  />
                <img class="img-responsive map-img-direction" src="img/map2.png" style="display: none;"  />
                <img class="img-responsive map-img-medium" src="img/map5.png"  />
                <img class="img-responsive map-img-direction-medium" src="img/map6.png" style="display: none;" />
                <img class="img-responsive map-img-small" src="img/map3.png"  />
                <img class="img-responsive map-img-direction-small" src="img/map4.png" style="display: none;" />
                <div class="map-window">
                    ...
                    <div class="direction">
                        ...
                        <span class="direction-marker"><img src="img/flecha.svg" alt="" /></span>
                    </div>
                    <div class="phone">
                        <span>TELEFONE</span>
    ...
    // adapt sidebar to about page layout
      $(document).ready(function($){
          $(window).scroll(function(){
              if ($(document).scrollTop() > 3258) {
                  $('#sidebar').hide();
              }else {
                  $('#sidebar').show();
              }

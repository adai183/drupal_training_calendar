            ...
            <div class="col-md-9">
                ...
                <div id="sec0" class="row margin-bottom-3">
                    <div class="col-md-12 top-link">
                        ...
                        <a href="#" style="color: #e27c72"> | Molecular Pharmacology </a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                ...
                <div class="row margin-top-5 scientific-report">
                    <a href="http://www.cib.csic.es/Memo/grupos/65.pdf" target="_blank">
                        ...
                        <div class="col-md-6 boss">
                            <div>
                                <a href="caballero.php">
                                    <img src="img/jose_caraval.png" alt="" class="img-responsive" style="height: 70px;" />
                                </a>
                            </div>
                            <div>
                                <div class="title">
                ...
                <div class="row margin-top-6">
                    <div class="col-md-12">
                        <div class="col-md-6 staff">
                            ...
                            <div class="subtitle">
                                <ul>
                                    <li>Sánchez-Puelles González-Carvajal, José María</li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-md-6 staff">
                            ...
                            <div class="subtitle">
                                <ul>
                                    <li>Sagrera Aparisi, Ana Maria</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <img class="img-responsive" src="img/mol_pharmacology.jpg"/>
                    </div>
                </div>
                ...
                <a href="#">
                    <div class="row margin-top-1 service-item">
                        <div class="colo-md-12" style="margin-left:10px;">
                            Sensor development platforms for detecting breast cancer markers; application to the study of the mechanisms of action of new anticancer drugs.
                        </div>
                    </div>
                </a>
                <a href="#">
                    <div class="row margin-top-1 service-item">
                        <div class="colo-md-12" style="margin-left:10px;">
                            Discovery and validation of therapeutic targets. Development of the platform Mhit .
                        </div>
                    </div>
                </a>
                <a href="#">
                    <div class="row margin-top-1 service-item">
                        <div class="colo-md-12" style="margin-left:10px;">
                            Utility of omic-based biomarkers in
                        </div>
                    </div>
                </a>
                <a href="#">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <ul>
                            <li>FUNDING ENTITY: Comunidad de Madrid, Ref.- S2010/BMD-2353</li>
                            <li>FUNDING ENTITY: EUROPEAN COMMISSION- FP7-HEALTH-2012-INNOVATION-1, Ref: 305483-2</li>
                            <li>FUNDING ENTITY:  AES 2012 – PS12/01628</li>
                        </ul>
                    </div>
                </div>
